...
@RestController
@RequestMapping("/api/admin/categoriess")
public class CategoryController {
    ...
    public CategoryController(CategoryRepository categoryRepo, IconRepository iconRepo, ProjectRepository projectRepo) {
    ...
    public ResponseEntity<?> create(@RequestBody CategoryRequest req,
        ...
        String iconLib = (req.getIconLibrary() == null || req.getIconLibrary().isBlank()) ? "Ionicons" : req.getIconLibrary().trim();
    ...
    public ResponseEntity<?> createBatch(@RequestBody List<CategoryRequest> list,
        ...
        // fail fast on missing projectId / name
